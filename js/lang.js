...
const translations = {
    en: {
        ...
        portfolio2_text: "gRPC Server using .net to consult information from Yu-Gi-Oh! & Web API Client to consume the gRPC services. Both built with .NET 8",
    ...
    es: {
        ...
        portfolio2_text: "Servidor gRPC usando .NET para consultar información de Yu-Gi-Oh! y cliente Web API para consumir los servicios gRPC. Ambos construidos con .NET 8.",
        portfolio2_demo: "https://ygoclient.application-service.work/swagger/index.html",
        portfolio2_github: "https://github.com/MiguelBrav/YGOWiki",
        portfolio3_title: "API URL Shortener",
